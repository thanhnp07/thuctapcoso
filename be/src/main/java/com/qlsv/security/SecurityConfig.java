    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/sinhvien/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/sinhvien/**").hasRole("ADMIN")
                .requestMatchers("/api/export/**").hasAnyRole("ADMIN", "USER")
                .requestMatchers("/api/khoa/**", "/api/lop/**").hasAnyRole("ADMIN", "USER")
                // Web pages - require form-based authentication
                .requestMatchers("/dashboard", "/sinhvien/**", "/khoa/**", "/lop/**").authenticated()
