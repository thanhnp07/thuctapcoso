...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (khoaRepository.count() == 0) {
            ...
            cntt = khoaRepository.save(cntt);
            ktdn = khoaRepository.save(ktdn);
            ngoaiNgu = khoaRepository.save(ngoaiNgu);
            dien = khoaRepository.save(dien);
            co = khoaRepository.save(co);
            hoa = khoaRepository.save(hoa);
            ...
            if (lopRepository.count() == 0) {
                ...
                cntt2020A = lopRepository.save(cntt2020A);
                cntt2020B = lopRepository.save(cntt2020B);
                ktdn2020A = lopRepository.save(ktdn2020A);
                dien2021A = lopRepository.save(dien2021A);
                co2021A = lopRepository.save(co2021A);
                hoa2021A = lopRepository.save(hoa2021A);
